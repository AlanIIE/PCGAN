...
def args():
    ...
    parser.add_argument("--number_of_batches", default=100, type=int, help="Number of batches per epoch")

    # parser.add_argument("--content_loss_layer", default='none', help='Name of content layer (vgg19)'
    #                                                                  ' e.g. block4_conv1 or none')

    parser.add_argument("--use_mask", default="0", type=int, help="Use the mask of generated by MASK RCNN")
    parser.add_argument("--use_body_mask", default=False, help="use_body_mask")
    ...
    parser.add_argument("--pose_checkpoint", default=None, help="Previosly saved model of pose_generate")
    ...
    parser.add_argument('--dataset', default='market', choices=['UCSDBirds', 'market', 'fasion', 'prw', 'fasion128', 'fasion128128'],
    ...
    parser.add_argument("--sigma", default=6, type=float, help='Sigma in the Gaussian function of the mask of stn')
    ...
    parser.add_argument("--disc_type", default='call', choices=['flip', 'none', 'call', 'sim', 'warp'],
    ...
    args.pairs_file_train = 'data/' + args.dataset + '-pairs-train-clear.csv'
    args.pairs_file_test = 'data/' + args.dataset + '-pairs-test-clear.csv'
    ...
    args.num_landmarks = 18 if args.pose_rep_type == 'hm' else 3
